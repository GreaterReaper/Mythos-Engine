      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className={`grim-card p-6 border-2 ${isHost ? 'border-[#b28a48]/40' : 'border-neutral-900'}`}>
            ...
            <p className="text-[9px] text-neutral-600 uppercase mb-4 leading-relaxed">Choose a custom word to make your portal easier to find.</p>
            <input 
              value={customSigil} 
          ...
          <div className={`grim-card p-6 border-2 ${!isHost ? 'border-[#b28a48]/40 shadow-lg' : 'border-neutral-900 opacity-50'}`}>
            ...
            <input value={targetId} onChange={(e) => setTargetId(e.target.value)} placeholder="TARGET SIGIL..." className="w-full bg-black border border-neutral-800 p-3 text-xs uppercase tracking-widest text-[#b28a48] focus:border-[#b28a48] mb-4 outline-none font-mono" />
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <div className="grim-card border-neutral-900 p-6 flex-1 min-h-[400px] flex flex-col shadow-2xl">
            ...
            <div className="flex-1 p-6 font-mono text-[10px] overflow-y-auto bg-black/40 scrollbar-hide">
              <div className="space-y-1">
                {serverLogs.length === 0 && <div className="text-neutral-800 italic">No events recorded in the ether...</div>}
                {serverLogs.map((log) => (
