  ...
  return (
    <div className="space-y-8 pb-20 max-w-4xl mx-auto">
      <div className="border-b border-red-900 pb-4">
        <h2 className="text-4xl font-cinzel text-[#a16207]">Ancient Laws</h2>
        <p className="text-gray-500 italic">"The laws of the Engine are written in obsidian and blood."</p>
      </div>

      <div className="rune-border p-6 md:p-10 bg-[#0c0a09]/80 backdrop-blur shadow-2xl relative">
        <div className="absolute top-4 right-4 text-red-900 opacity-20 pointer-events-none">
        ...
        <div className="mt-10 pt-6 border-t border-red-900/20 flex justify-center">
           <div className="text-[10px] text-gold tracking-[0.5em] font-black uppercase">ᛟ ᚱ ᛞ ᛖ ᚱ • ᚺ ᚨ ᛟ ᛊ</div>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-5 bg-red-900/5 border border-red-900/20 rounded">
          <h4 className="font-cinzel text-red-800 uppercase text-xs mb-2 font-bold">The Arbiter</h4>
          <p className="text-[10px] text-gray-500 leading-relaxed">The Gemini 3 Pro AI serves as the ultimate arbiter of fate. Its word is law, and its narrative manifests the world around thee.</p>
        </div>
